...
rules.add_perm(
    "view_product", is_authenticated | is_customer | is_staff | is_admin | is_superuser
)
...
rules.add_perm(
    "view_review",
    is_authenticated | is_customer | is_staff | is_admin | is_superuser | is_reviewer,
)

rules.add_perm("create_discount", is_admin | is_superuser)
rules.add_perm("deactivate_discount", is_admin | is_superuser)
rules.add_perm("reactivate_discount", is_admin | is_superuser)
rules.add_perm("delete_discount", is_admin | is_superuser)
rules.add_perm("update_discount", is_admin | is_superuser)
rules.add_perm(
    "view_discount", is_authenticated | is_customer | is_staff | is_admin | is_superuser
)
